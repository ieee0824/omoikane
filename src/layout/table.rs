...
pub(super) fn layout_table_container(
    ...
    Some(LayoutBox {
        ...
        position_scheme: super::position_scheme(&style),
        fixed_containing_block: super::establishes_fixed_containing_block(&style),
...
fn layout_table_row_entry(
    ...
    let row_box = LayoutBox {
        ...
        position_scheme: super::PositionScheme::Static,
