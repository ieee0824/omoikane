...
最新の公式比較差分は 28px で、主残差は下半分よりも鼻・目周辺に寄っている。
...
- `cargo test paint::tests::acid2_fixture_matches_official_reference_rendering --lib -- --ignored` の最新差分は 28px。下半分の大枠は揃っており、本 issue は実質的に終盤
